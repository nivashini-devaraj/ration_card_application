          ...
          <div className="accordion-item">
            ...
            <div className="submit-contact-box">
                ...
                <div className="submit-contact-left">
                    <div className="submit-contact-icon"><img src={contacticon1} className="image image-fluid"/></div>
                    <div>
                ...
                <div className="submit-contact-row">
                <div className="submit-contact-left">
                    <div className="submit-contact-icon"><img src={contacticon2} className="image image-fluid"/></div>
                    <div>
                ...
                <div className="submit-contact-row">
                <div className="submit-contact-left">
                    <div className="submit-contact-icon"><img src={contacticon3} className="image image-fluid"/></div>
                    <div>
